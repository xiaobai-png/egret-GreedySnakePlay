...
declare namespace eui {
    ...
    class DataGroup extends Group {
         ...
         */
        protected createChildren(): void;
        private initScrollerFlg;
        setInitScrollerFlg(flg: boolean): void;
        getInitScrollerFlg(): boolean;
        private scrollerChangeHeight;
        setScrollerChangeHeight(num: number): void;
        /**
         * @inheritDoc
         *
         * @version Egret 2.4
